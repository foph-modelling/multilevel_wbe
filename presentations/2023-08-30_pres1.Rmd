...
author: "Julien Riou, James Munday"
date: "30 August 2023"
output: 
  beamer_presentation:
    colortheme: "spruce"
...
-   overall \alert{time trend} by region (RW2)

-   \alert{systematic shift} for each ARA (IID)

-   deviations from regional trend for each ARA (RW1) \pause
...
- Improved spatio-temporal model (SPDE) \pause
...
- Assess the \alert{agreement} with other types of surveillance (obs. 3; joint modelling of reported cases/hospitalizations and viral load) \pause

...
#+ ma5.4.5b, fig.width=8, fig.height=4,  R.options = list(width = 1000)
avg_time_trend_reg(ww_all,ma5.4.5)
#+ ma5.4.5c, fig.width=8, fig.height=6,  R.options = list(width = 1000)
mw_130_map_relative_vl(ma5.4.5,corr_all_ara,shapes)
#+ ma5.4.5d, fig.width=8, fig.height=6,  R.options = list(width = 1000)

...
```{r desc, fig_desc, fig.width=8, fig.height=3.5}
# select one ARA
chosen_ara = "Aarau"
# data management
ww_one = ww1 %>% 
...
```{r ma1,  R.options = list(width = 1000)}
ma1 = INLA::inla(vl ~ 1 + 
...
```{r ma2,  R.options = list(width = 1000)}
ma2 = INLA::inla(vl ~ 1 +
                   f(below_loq,model="iid") +
...
```{r ma3,  R.options = list(width = 1000)}
ma3 = INLA::inla(vl ~ 1 +
                   f(below_loq,model="iid") +
...
```{r ma4,  R.options = list(width = 1000)}
ma4 = INLA::inla(vl ~ 1 +
                   f(below_loq,model="iid") +
...
```{r ma5, R.options = list(width = 1000)}
ma5 = INLA::inla(vl ~ 1 +
...
```{r ma6, R.options = list(width = 1000)}
ww_one = ww_one %>% 
...
```{r ma5basel, R.options = list(width = 1000)}
chosen_ara = "Basel"
ww_one = ww1 %>% 
  filter(ara_name==chosen_ara) %>% 
  # log
...
```{r ma5bern, R.options = list(width = 1000)}
...
```{r ma5saanen, R.options = list(width = 1000)}
chosen_ara = "Saanen"
# data management
ww_one = ww1 %>% 
  filter(ara_name==chosen_ara) %>% 
...
```{r ma5laupen, R.options = list(width = 1000)}
chosen_ara = "Laupen"
# data management
ww_one = ww1 %>% 
  filter(ara_name==chosen_ara) %>% 

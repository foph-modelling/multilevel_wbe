...
```{r ma5.3.1, fig.width=8, fig.height=12,  R.options = list(width = 1000)}
if(controls$rerun_models) {
...
```
```{r ma5.3.1b, fig.width=8, fig.height=4,  R.options = list(width = 1000)}
avg_time_trend(ww_all,ma5.3.1)
```
```{r ma5.3.1c, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
mw_130_map_relative_vl(ma5.3.1,corr_all_ara,shapes)
```
```{r ma5.3.1d, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
...
```{r ma5.3.2a, fig.width=8, fig.height=12,  R.options = list(width = 1000)}
if(controls$rerun_models) {
...
```
```{r ma5.3.2b, fig.width=8, fig.height=4,  R.options = list(width = 1000)}
avg_time_trend(ww_all,ma5.3.2)
```
```{r ma5.3.2c, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
mw_130_map_relative_vl(ma5.3.2,corr_all_ara,shapes)
```
```{r ma5.3.2d, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
...
```{r ma5.3.3a, fig.width=8, fig.height=12,  R.options = list(width = 1000)}
if(controls$rerun_models) {
...
```
```{r ma5.3.3b, fig.width=8, fig.height=4,  R.options = list(width = 1000)}
avg_time_trend_reg(ww_all,ma5.3.3)
```
```{r ma5.3.3c, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
mw_130_map_relative_vl(ma5.3.3,corr_all_ara,shapes)
```
```{r ma5.3.3d, fig.width=8, fig.height=6,  R.options = list(width = 1000)}

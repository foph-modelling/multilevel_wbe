...
```{r ma5.4.0, fig.width=8, fig.height=12,  R.options = list(width = 1000)}
# if(FALSE) {
...
```
```{r ma5.4.0a, fig.width=8, fig.height=12,  R.options = list(width = 1000)}
ppp_vl_ara(ww_all,ma5.4.0)
```
```{r ma5.4.0b, fig.width=8, fig.height=4,  R.options = list(width = 1000)}
avg_time_trend(ww_all,ma5.4.0)
```
```{r ma5.4.0c, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
mw_130_map_relative_vl(ma5.4.0,corr_all_ara,shapes)
```
```{r ma5.4.0d, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
...
```
```{r ma5.4.1a, fig.width=8, fig.height=12,  R.options = list(width = 1000)}
ppp_vl_ara(ww_all,ma5.4.1)
```
```{r ma5.4.1b, fig.width=8, fig.height=4,  R.options = list(width = 1000)}
avg_time_trend(ww_all,ma5.4.1)
```
```{r ma5.4.1c, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
mw_130_map_relative_vl(ma5.4.1,corr_all_ara,shapes)
```
```{r ma5.4.1d, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
...
```
```{r ma5.4.2a, fig.width=8, fig.height=12,  R.options = list(width = 1000)}
ppp_vl_ara(ww_all,ma5.4.2)
```
```{r ma5.4.2b, fig.width=8, fig.height=4,  R.options = list(width = 1000)}
avg_time_trend(ww_all,ma5.4.2)
```
```{r ma5.4.2c, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
mw_130_map_relative_vl(ma5.4.2,corr_all_ara,shapes)
```
```{r ma5.4.2d, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
...
```
```{r ma5.4.3a, fig.width=8, fig.height=12,  R.options = list(width = 1000)}
ppp_vl_ara(ww_all,ma5.4.3)
```
```{r ma5.4.3b, fig.width=8, fig.height=4,  R.options = list(width = 1000)}
avg_time_trend_reg(ww_all,ma5.4.3)
```
```{r ma5.4.3c, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
mw_130_map_relative_vl(ma5.4.3,corr_all_ara,shapes)
```
```{r ma5.4.3d, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
...
```
```{r ma5.4.4a, fig.width=8, fig.height=12,  R.options = list(width = 1000)}
ppp_vl_ara(ww_all,ma5.4.4)
```
```{r ma5.4.4b, fig.width=8, fig.height=4,  R.options = list(width = 1000)}
avg_time_trend(ww_all,ma5.4.4)
```
```{r ma5.4.4c, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
mw_130_map_relative_vl(ma5.4.4,corr_all_ara,shapes)
```
```{r ma5.4.4d, fig.width=8, fig.height=6,  R.options = list(width = 1000)}
...
```
```{r ma5.4.5a, fig.width=8, fig.height=12}
ppp_vl_ara(ww_all,ma5.4.5)
```
```{r ma5.4.5b, fig.width=8, fig.height=4}
avg_time_trend_reg(ww_all,ma5.4.5)
```
```{r ma5.4.5c, fig.width=8, fig.height=6}
mw_130_map_relative_vl(ma5.4.5,corr_all_ara,shapes)
```
```{r ma5.4.5d, fig.width=8, fig.height=6}
